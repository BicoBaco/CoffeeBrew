...
<html>
		...
		<div class="container-fluid row px-0 vh-100">
			<div class="card mx-auto my-auto" style="width: 28rem;">
				<div class="card-body" id="cardForm">
					...
					<div class="alert" role="alert" id="statoConnessione"></div>
	...
	<script>
		...
		function feedback(risposta) {
			if(risposta == "Connection success") {
				$("#statoConnessione").removeClass('alert-danger alert-warning').addClass('alert-success').html("Connesso al distributore "+connessioneId.value);
			} else if(risposta == "Occupied") {
				$("#statoConnessione").removeClass('alert-success alert-danger').addClass('alert-warning').html("Il distributore "+connessioneId.value+" è occupato");
			} else if(risposta == "Missing id"){
				$("#statoConnessione").removeClass('alert-warning alert-danger').addClass('alert-danger').html("Il distributore "+connessioneId.value+" non esiste");
			}
		}
